...
% --- Abstrak ---
\begin{abstract}
Sektor properti memiliki peran vital dalam perekonomian nasional, namun penentuan harga rumah seringkali menjadi tantangan karena dipengaruhi oleh berbagai faktor fisik yang saling berinteraksi. Penelitian ini mengimplementasikan algoritma numerik berbasis Normal Equation untuk menyelesaikan masalah aproksimasi harga rumah. Berbeda dengan pendekatan iteratif konvensional, Normal Equation merupakan metode langsung yang menghasilkan solusi aproksimasi parameter model melalui operasi matriks dalam satu langkah komputasi, tanpa memerlukan penentuan tingkat pembelajaran atau proses iterasi berulang. Data yang digunakan berasal dari dataset publik Daftar Harga Rumah di Kaggle, yang mencakup 1001 transaksi properti di Jakarta Selatan. Fitur yang dianalisis meliputi luas tanah, luas bangunan, jumlah kamar tidur, jumlah kamar mandi, dan ketersediaan garasi. Hasil eksperimen menunjukkan bahwa metode ini menghasilkan prediksi dengan nilai R-squared sebesar 0.836, mengindikasikan bahwa model dapat menjelaskan 83.6 persen variasi harga properti di wilayah tersebut, dengan tingkat kesalahan rata-rata (MAPE) sebesar 27.07 persen.
\end{abstract}
...
Untuk memberikan gambaran konkret mengenai performa model di dunia nyata, Tabel \ref{tab:sampel} menampilkan perbandingan harga asli dan prediksi pada lima data acak dari data uji.
